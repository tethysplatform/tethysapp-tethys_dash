...
// carrying real geometry (see `rankQueriedFeatures`).
//
// Keep this beside CLIENT_VECTOR_SOURCE_TYPES: a new source type that fabricates
// its geometry the same way belongs here, and a new one that returns real
