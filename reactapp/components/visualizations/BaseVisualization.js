...
const BaseVisualization = ({rowHeight, colWidth, itemData, showFullscreen, hideFullscreen}) => {
  ...
  function getPlotData() {
    ...
    .then((data) => {
      ...
      setViz(<BasePlot plotData={plotData} rowHeight={rowHeight} colWidth={colWidth}/>)
    });
  }
  ...
  return (
    <>
      {viz}
      <FullscreenPlotModal showModal={showFullscreen} handleModalClose={hideFullscreen}>
        {viz}
      </FullscreenPlotModal>
    </>
  )
