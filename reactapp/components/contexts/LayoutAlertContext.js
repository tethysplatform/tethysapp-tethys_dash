...
const LayoutAlertContextProvider = ({ children }) => {
  ...
  return (
    <LayoutSuccessAlertContext.Provider value={[successMessage, setSuccessMessage, showSuccessMessage, setShowSuccessMessage]}>
      <LayoutErrorAlertContext.Provider value={[errorMessage, setErrorMessage, showErrorMessage, setShowErrorMessage]}>
        <LayoutWarningAlertContext.Provider value={[warningMessage, setWarningMessage, showWarningMessage, setShowWarningMessage]}>
          {children}
